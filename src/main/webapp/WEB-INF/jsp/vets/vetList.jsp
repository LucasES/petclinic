...
<div class="container">
    ...
    <table class="table-buttons">
        <tr>
            <td>
                <a href="<spring:url value="/vets.xml" htmlEscape="true" />"><fmt:message key="viewXML"/></a>
            </td>
            <td>
                <a href="<spring:url value="/vets.atom" htmlEscape="true" />"><fmt:message key="subAtomFeed"/></a>
            </td>
        </tr>
    </table>
